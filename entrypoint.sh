...
git clone --single-branch --branch $INPUT_DESTINATION_BRANCH "https://${INPUT_USER_NAME}:${API_TOKEN_GITHUB}@${INPUT_GITHUB_SERVER}/${INPUT_DESTINATION_REPO}.git" "$CLONE_DIR"
